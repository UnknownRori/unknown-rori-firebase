    ...
    return (
        <div className="top-24 fixed z-10">
            <button onClick={toggleState}
                className={`button-secondary fixed m-3 ${state ? 'translate-x-14' : '-translate-x-8'} 
                w-12 transition-all duration-1000 z-10`}
            >
                <img src={arrow} alt="=>"
                    className={`${state ? 'rotate-0' : 'rotate-180'} transition-all duration-1000`}
                />
            </button>
