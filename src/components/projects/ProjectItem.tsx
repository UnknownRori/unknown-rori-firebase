...
export class ProjectItem extends React.Component<{ project: projectItem}> {
    render(): ReactNode {
        return(
            <div className="md:w-3/12 sm:w-6:12 m-5 p-5 bg-gray-700 bg-opacity-60 rounded-md shadow-2xl ring-1 ring-gray-400 duration-1000
                           hover:z-50 hover:-translate-y-5 hover:bg-gray-800 hover:bg-opacity-95 hover:ring-gray-600 hover:shadow-md"
            >
